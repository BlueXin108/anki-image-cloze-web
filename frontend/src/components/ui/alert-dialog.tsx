...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/40 duration-400 supports-backdrop-filter:backdrop-blur-md ease-[cubic-bezier(0,.43,0,.99)] data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
